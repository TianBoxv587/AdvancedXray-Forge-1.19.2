...
public class GuiSelectionScreen extends GuiBase {
    ...
    public void init() {
        ...
        // side bar buttons
        addRenderableWidget(new SupportButtonInner((getWidth() / 2) + 79, getHeight() / 2 - 82, 120, 20, I18n.get("xray.input.del_all"), "xray.tooltips.del_all", button -> {
