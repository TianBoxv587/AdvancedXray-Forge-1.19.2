...
public class Configuration
{
    ...
    public static class General {
        ...
        public final ForgeConfigSpec.DoubleValue updateRadiusScale;
        ...
        General() {
            ...
            updateRadiusScale = BUILDER
                    .comment("Rendering will be updated when you move beyond range*updateRadiuScale.")
                            .defineInRange("updateRadiusScale",0.5,0.5,1);
